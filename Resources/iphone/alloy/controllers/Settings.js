function Controller() {
    ...
    $.__views.__alloyId27.add($.__views.username.getViewEx({
        recurse: true
    }));
    $.__views.cloudBackup = Alloy.createWidget("ti.ux.forms.row.switch", "widget", {
        title: "  Cloud Backup",
    ...
    $.__views.__alloyId27.add($.__views.cloudBackup.getViewEx({
        recurse: true
    }));
    $.__views.optDistance = Alloy.createWidget("ti.ux.forms.row.optionspicker", "widget", {
        title: " Distance Measurement",
    ...
    $.__views.__alloyId27.add($.__views.optDistance.getViewEx({
        recurse: true
    }));
    ...
    $.__views.__alloyId30.add($.__views.beaconEnabled.getViewEx({
        recurse: true
    }));
    $.__views.beaconName = Alloy.createWidget("ti.ux.forms.row.text", "widget", {
        title: "",
    ...
    $.__views.__alloyId30.add($.__views.beaconName.getViewEx({
        recurse: true
    }));
    $.__views.beaconUUID = Alloy.createWidget("ti.ux.forms.row.text", "widget", {
        title: "",
    ...
    $.__views.__alloyId30.add($.__views.beaconUUID.getViewEx({
        recurse: true
    }));
    $.__views.beaconMajor = Alloy.createWidget("ti.ux.forms.row.text", "widget", {
        title: "",
    ...
    $.__views.__alloyId30.add($.__views.beaconMajor.getViewEx({
        recurse: true
    }));
    $.__views.beaconMinor = Alloy.createWidget("ti.ux.forms.row.text", "widget", {
        title: "",
    ...
    $.__views.__alloyId30.add($.__views.beaconMinor.getViewEx({
        recurse: true
    }));
    ...
    $.__views.__alloyId33.add($.__views.btnSave);
