...
//@interface TripLogrObject : NSObject
//@end

@interface TripLogrObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TripLogrObject class]])
		{
			for (NSString *key in [[(TripLogrObject*)o modules] allKeys])
			{
