...
// in simulator we redefine to format for TripLogr Developer console
...
{\
	NSString * exceptionName = [@"org.triplogr." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.triplogr";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UITripLogrNativeItemNone = -1, 
	UITripLogrNativeItemSpinner = -2,
	UITripLogrNativeItemProgressBar = -3,
	
	UITripLogrNativeItemSlider = -4,
	UITripLogrNativeItemSwitch = -5,
	UITripLogrNativeItemMultiButton = -6,
	UITripLogrNativeItemSegmented = -7,
	
	UITripLogrNativeItemTextView = -8,
	UITripLogrNativeItemTextField = -9,
	UITripLogrNativeItemSearchBar = -10,
	
	UITripLogrNativeItemPicker = -11,
	UITripLogrNativeItemDatePicker = -12,
	
	UITripLogrNativeItemInfoLight = -13,
	UITripLogrNativeItemInfoDark = -14,
	
	UITripLogrNativeItemDisclosure = -15,
	
	UITripLogrNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all TripLogr instances of
